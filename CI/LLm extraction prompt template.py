...
if __name__ == "__main__":
    sample_email_subject = "Your Spotify Premium subscription"
    sample_email_body = """
Hi Alex,

Your Spotify Premium subscription has been renewed.

Subscription: Spotify Premium Individual
Price: $10.99/month
Next charge: December 22, 2025
Payment: Visa ending in 1234

Manage your plan: https://www.spotify.com/account/subscription

Thanks for listening!
The Spotify Team
"""
    
    prompt = build_extraction_prompt(sample_email_subject, sample_email_body)
    print(prompt)
    
    # In production, you would send this prompt to GPT-4/Claude:
